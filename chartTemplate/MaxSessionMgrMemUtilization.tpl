class=TimeChart
title=Session Manager Maximum Memory Utilization (%)
rangeText=Percentage
width=1600
height=350
threshold=75
outputFile=MaxSessMgrMemUtilization.png
query=select timestamp(EMS_Card2.`localdate`,EMS_Card2.`localtime`) as 'timestamp',EMS_Card2.node_hostname, EMS_Card2.`task-sessmgr-maxmem` \
from mos.EMS_Card2 \
...
select timestamp(EMS_Card2.`localdate`,EMS_Card2.`localtime`) as 'timestamp',EMS_Card2.node_hostname, EMS_Card2.`task-sessmgr-maxmem` \
from mos.EMS_Card2 \

...
SELECT sgwAR.node_hostname, ROUND((`Current SGW Sessions`)) as 'Current SGW Sessions ARG' FROM (
...
SELECT sgwPY.node_hostname, ROUND((`Current SGW Sessions`)) as 'Current SGW Sessions PY' FROM (
SELECT timestamp(EMS_SGW1.`localdate`,EMS_SGW1.`localtime`) as 'timestamp',EMS_SGW1.node_hostname, EMS_SGW1.servname, 
EMS_SGW1.`sess-cur` as 'Current SGW Sessions' 
FROM mos.EMS_SGW1 
...
SELECT sgwUY.node_hostname, ROUND((`Current SGW Sessions`)) as 'Current SGW Sessions UY' FROM (
SELECT timestamp(EMS_SGW1.`localdate`,EMS_SGW1.`localtime`) as 'timestamp',EMS_SGW1.node_hostname, EMS_SGW1.servname, 
EMS_SGW1.`sess-cur` as 'Current SGW Sessions' 
FROM mos.EMS_SGW1 
